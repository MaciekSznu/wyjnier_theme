<section class="priv-policy">
  <h2 class="priv-policy__title">Polityka prywatności</h2>
  <h3 class="priv-policy__section-title">
  ...
  <h3 class="priv-policy__section-title">1. Informacje ogólne</h3>
  <ol>
    <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <b>wyjatkowenieruchomosci.pl</b></li>
    <li>
      Operatorem serwisu oraz Administratorem danych osobowych jest: Michał Bysiek ul. Gołaśka 15/23, 30-619 Kraków
    </li>

    <li>Adres kontaktowy poczty elektronicznej operatora: biuro@wyjatkowenieruchomosci.pl</li>
  ...
  <h3 class="priv-policy__section-title">2. Wybrane metody ochrony danych stosowane przez Operatora</h3>
  <ol>
    <li>Operator okresowo zmienia swoje hasła administracyjne.</li>
    <li>
      Istotnym elementem ochrony danych jest regularna aktualizacja wszelkiego oprogramowania, wykorzystywanego przez
      Operatora do przetwarzania danych osobowych, co w szczególności oznacza regularne aktualizacje komponentów
      programistycznych.
    </li>
  </ol>
  <h3 class="priv-policy__section-title">3. Hosting</h3>
  <ol>
    <li>Serwis jest hostowany (technicznie utrzymywany) na serwera operatora: home.pl</li>
  </ol>
  <h3 class="priv-policy__section-title">4. Twoje prawa i dodatkowe informacje o sposobie wykorzystania danych</h3>
  <ol>
    <li>
    ...
    <li>
      Twoje dane osobowe przetwarzane przez Administratora nie dłużej, niż jest to konieczne do wykonania związanych z
      nimi czynności określonych osobnymi przepisami (np. o prowadzeniu rachunkowości). W odniesieniu do danych
    ...
    <li>
      Przysługuje Ci prawo do złożenia sprzeciwu w zakresie przetwarzania wskazanego w pkt 3.3 c) wobec przetwarzania
    ...
    <li>
      Na działania Administratora przysługuje skarga do Prezesa Urzędu Ochrony Danych Osobowych, ul. Stawki 2, 00-193
      Warszawa.
    </li>
    <li>Podanie danych osobowych jest dobrowolne, lecz niezbędne do obsługi Serwisu.</li>
    <li>
      W stosunku do Ciebie mogą być podejmowane czynności polegające na zautomatyzowanym podejmowaniu decyzji, w tym
  ...
  <h3 class="priv-policy__section-title">5. Informacje w formularzach</h3>
  <ol>
    <li>
    ...
    <li>
      Dane podane w formularzu są przetwarzane w celu wynikającym z funkcji konkretnego formularza, np. w celu dokonania
      procesu obsługi zgłoszenia serwisowego lub kontaktu handlowego, rejestracji usług itp. Każdorazowo kontekst i opis
      formularza w czytelny sposób informuje, do czego on służy.
    </li>
  </ol>

  <h3 class="priv-policy__section-title">6. Logi Administratora</h3>
  <ol>
    <li>
  ...
  <h3 class="priv-policy__section-title">7. Istotne techniki marketingowe</h3>
  <ol>
    <li>
  ...
  <h3 class="priv-policy__section-title">8. Informacja o plikach cookies</h3>
  <ol>
  ...
  <h3 class="priv-policy__section-title">9. Zarządzanie plikami cookies – jak w praktyce wyrażać i cofać zgodę?</h3>
  <ol>
    <li>
    ...
    <li>
      W celu zarządzania ustawienia cookies wybierz z listy poniżej przeglądarkę internetową, której używasz i postępuj
